create procedure insert_category_one(IN name_category_in varchar(255), IN parent_category_in varchar(255),
                                     IN id_category_in varchar(255), IN id_shop_in varchar(255),
                                     OUT id_cat_out varchar(255))
BEGIN
    ...
    THEN
        ...
        INSERT INTO `ps_category` (`id_category`,
                                   ...
                                   `date_add`,
                                   `date_upd`)
        VALUES (NULL, parent_category_in, '1', @level_depth, DEFAULT, DEFAULT, '1', CURRENT_TIMESTAMP,
                CURRENT_TIMESTAMP);
        ...
        INSERT INTO `ps_category_lang` (`id_category`,
                                        ...
                                        `meta_keywords`,
                                        `meta_description`)
        VALUES (LAST_INSERT_ID(), id_shop_in, '1', name_category_in, '', (SELECT transliterate(name_category_in)), '',
                '', ''),
               (LAST_INSERT_ID(), id_shop_in, '2', name_category_in, '', (SELECT transliterate(name_category_in)), '',
                '', '');
